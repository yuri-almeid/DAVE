...
r = sr.Recognizer() # Cria reconhecimento de fala
...
def rec():
    ...
    try:
        quest = r.recognize_google(audio)
    except:
        print("D.A.V.E.: I Could not hear you!")
        say("I Could not hear you!")
        print("D.A.V.E.: Try say again!")
        say("Try say again!")
        quest = None
    return quest
